    ...
    private SendMessage processUsersInput(Message inputMsg) {
        ...
        if (botState.equals(BotState.PROFILE_FILLED)) {
            ...
            /*ConnectionString connString = new ConnectionString(
                    "mongodb+srv://admin:NQNyraJTfQdhHT8@cluster0.llnyj.mongodb.net/?retryWrites=true&w=majority"
            );
            ...
            MongoDatabase database = mongoClient.getDatabase("myquizBot_embeddeddb");*/
